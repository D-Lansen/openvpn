...
#include "../../include/internal/deprecated.h" /* to be able to use EC_KEY and EC_GROUP */

#include "../../include/openssl/err.h"
#include "../../include/crypto/sm2err.h"
#include "../../include/crypto/sm2.h"
#include "../../include/openssl/ec.h" /* EC_KEY and EC_GROUP functions */
