...
public class MainFragment extends Fragment implements View.OnClickListener, Handler.Callback {
    ...
    private void startEmbeddedProfile() {
        try {
            ...
            try {
                conf = getActivity().getAssets().open("lichen02.ovpn");
            } catch (IOException e) {
                conf = getActivity().getAssets().open("lichen01.ovpn");
            }
        ...
        Toast.makeText(getActivity(), "Profile Add", Toast.LENGTH_LONG).show();
    }
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className,
            ...
            try {
                ...
                Log.e("lichen", "onServiceConnected:" + ((i != null) ? "true" : "false"));
                if (i != null) {
    ...
    private void bindService() {
        ...
        getActivity().bindService(openvpnService, mConnection, Context.BIND_AUTO_CREATE);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.e("lichen", "onActivityResult");
        if (resultCode == Activity.RESULT_OK) {
            Log.e("lichen", "requestCode:" + requestCode);
            if (requestCode == START_PROFILE_BYUUID)
                try {
                    Log.e("lichen", "onActivityResult:startProfile(mStartUUID)");
